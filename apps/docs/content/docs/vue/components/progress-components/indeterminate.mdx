...
import { Indeterminate } from '@lop-town/bprogress-...';
</script>
```

<Callout title="Note">
  Replace the `...` in the import with the library you're using. For example, if you use `@lop-town/bprogress-nuxt`, import by doing `from '@lop-town/bprogress-nuxt'`
</Callout>
