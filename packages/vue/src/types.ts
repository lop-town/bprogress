...
interface DefaultComponentWithSelectorProps extends DefaultComponentProps {
  classSelector?: string;
}

export interface ProgressProps extends DefaultComponentProps {
  style?: string | CSSProperties;
}
export interface BarProps extends DefaultComponentWithSelectorProps {}
